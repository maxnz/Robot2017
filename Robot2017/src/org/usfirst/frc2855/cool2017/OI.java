...
public class OI {
    ...
    public JoystickButton LEDflashbutton;
    public JoystickButton LEDbreathbutton;
    public JoystickButton recalibrateGyro;
    public OI() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        descendButton.whileHeld(new Unclimb());
        LEDflashbutton = new JoystickButton(joystick2, 8);
        LEDflashbutton.whileHeld(new LEDs(true));
        LEDbreathbutton = new JoystickButton(joystick2, 9);
        LEDbreathbutton.whileHeld(new LEDs(false));
        SmartDashboard.putNumber("Shooter Throttle", (Robot.oi.getJoystick2().getThrottle()+1)*50);
        SmartDashboard.putData("FlashLEDs", new LEDs(true));
        SmartDashboard.putData("GIVE MY ROBOT LIFE!!!", new LEDs(false));
        SmartDashboard.putData("Recalibrate Gyro", new ResetGyro());
